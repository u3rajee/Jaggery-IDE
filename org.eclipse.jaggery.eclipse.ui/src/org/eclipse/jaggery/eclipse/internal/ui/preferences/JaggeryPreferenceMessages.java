...
public class JaggeryPreferenceMessages extends NLS{
	
	private static final String BUNDLE_NAME = "org.eclipse.jaggery.eclipse.internal.ui.preferences.JaggeryPreferenceMessages";//$NON-NLS-1$
...
//	
	public static String NewJAGProjectPreferencePage_description;
	public static String NewJAGProjectPreferencePage_sourcefolder_label;
	public static String NewJAGProjectPreferencePage_sourcefolder_project;
	public static String NewJAGProjectPreferencePage_sourcefolder_folder;
    public static String NewJAGProjectPreferencePage_folders_src;
//	
//	
...
//	public static String CodeFormatterPreferencePage_description;
	...
	static {
		NLS.initializeMessages(BUNDLE_NAME, JaggeryPreferenceMessages.class);
	}
